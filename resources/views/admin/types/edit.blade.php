<form action="{{ route('type.update', $type->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <el-dialog>
        <dialog id="editType{{ $type->id }}" aria-labelledby="dialog-title"
                ...
                <el-dialog-panel
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div>
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <h3 id="dialog-title" class="text-[20px] font-semibold text-black">Edit Type</h3>
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="text" name="type" id="type"
                                        ...
                                        class="mt-1 block w-full p-2 border border-black rounded-md text-black text-sm">
                                ...
                                <div class="mt-4">
                                    ...
                                    @if ($type->image)
                                        <div class="mt-3">
                                            ...
                                            <img src="{{ asset('assets/type/' . $type->image) }}"
                                                alt="Current Image"
                    ...
                    <div class="bg-gray-700/25 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button type="submit" command="close" commandfor="dialog"
                            class="inline-flex w-full justify-center rounded-md bg-blue-500 px-3 py-2 text-sm font-semibold text-white sm:ml-3 sm:w-auto">
                            Submit
                        </button>

                        <button type="button" command="close" commandfor="editType{{ $type->id }}"
                            class="mt-3 inline-flex w-full justify-center rounded-md bg-black px-3 py-2 text-sm font-semibold text-white sm:mt-0 sm:w-auto">
                            Cancel
                        </button>
                    </div>
