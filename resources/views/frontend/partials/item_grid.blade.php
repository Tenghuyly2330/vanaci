@if ($subcategories->count())
    <div class="subcategory-bar flex whitespace-nowrap space-x-2 mt-10 px-4 w-full overflow-x-auto scrollbar-hide">
        @if ($type && $category)
...
<div id="item-grid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 px-4 max-w-7xl mx-auto py-10">
