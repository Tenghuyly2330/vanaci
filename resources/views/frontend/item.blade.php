            ...
            @forelse ($items as $item)
                ...
                <div class="overflow-hidden relative">
                    ...
                    <div class="flex items-start justify-between p-2 mt-auto">
                        ...
                        <div>
                            <button
                                x-data="{ added: $store.cart.items.some(i => i.id == '{{ $item->id }}') }"
                                @click="
                                    added = !added;
                            ...
                            >
                                <!-- Default Cart Icon -->
                                <svg x-show="!added" class="w-5 h-5 absolute inset-0 m-auto" viewBox="0 0 6 7" fill="none" xmlns="http://www.w3.org/2000/svg">
