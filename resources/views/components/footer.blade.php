<section class="w-full flex flex-col md:flex-row justify-center gap-4 lg:gap-x-16 md:gap-x-10 px-10 pt-10 pb-4">
    <div class="text-[12px]">
        <h1 class="text-[15px] font-[600]">Category</h1>
        @foreach ($types as $type)
            <ul class="relative top-[10px]">
                <li><a href="{{ route('item', ['type' => $type->slug]) }}">{{ $type->type }}</a></li>
            </ul>
        @endforeach
    </div>

    <div class="text-[12px]">
        <h1 class="text-[15px] font-[600]">Visit Stores</h1>

        <div class="relative top-[10px] flex flex-col gap-5">

            <!-- Clobber BKK -->
            <div class="flex flex-col gap-1 text-[14px] h-40">
                <h1 class="font-[400]">Clobber BKK</h1>
                <div class="w-full h-64 bg-gray-300 rounded-md overflow-hidden">
                    <iframe class="w-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3908.9539521959637!2d104.92045990914797!3d11.555158888597624!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310951006db2f24f%3A0xdbf43fac2a8d4a2d!2sClobber%20BKK%20(Runway)!5e0!3m2!1sen!2skh!4v1763958399340!5m2!1sen!2skh"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>

            <!-- Clobber TK -->
            <div class="flex flex-col gap-1 text-[14px] h-40">
                <h1 class="font-[400]">Clobber TK</h1>
                <div class="w-full h-64 bg-gray-300 rounded-md overflow-hidden">
                    <iframe class="w-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3908.6874587344237!2d104.8948434!3d11.5742485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310951e7ef431551%3A0x4a9536e2e9acd5ae!2sClobber%20TK%20(%20Warehouse%20)!5e0!3m2!1sen!2skh!4v1763958469552!5m2!1sen!2skh" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
    ...
    <div class="text-[12px]">
        <h1 class="text-[15px] font-[600]">Follow Us</h1>
        <ul class="flex items-center gap-2 relative top-[10px]">
            <li>
...
{{-- Map --}}
{{-- <h1 class="font-[400]">Clobber BKK</h1>
<a href="https://maps.app.goo.gl/vTwby9i35e5TA5f28" class="underline">https://maps.app.goo.gl/vTwby9i35e5TA5f28</a> --}}

{{-- <h1 class="font-[400]">Clobber TK</h1>
<a href="https://maps.app.goo.gl/hB11LhE1mpoNcUzT7" class="underline">https://maps.app.goo.gl/hB11LhE1mpoNcUzT7</a> --}}