...
<div class="sticky top-0 left-0 w-full flex items-center justify-between h-16 lg:h-20 text-white px-4 z-[45] bg-white">
    ...
    <div class="flex items-center gap-2 w-1/3" x-data="{ cartOpen: false, menuOpen: false }">
        ...
        <!-- Cart Button -->
        <div class="relative">
            <button @click="cartOpen = !cartOpen" class="relative flex items-center gap-2 text-black p-1">

                {{-- Shopping Cart SVG Icon --}}
                <svg width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M3.82483 4.85948H2.53366C1.64146 4.85948 0.900877 5.54904 0.837218 6.4393L0.00430862 18.102C-0.0292218 18.5729 0.13405 19.0365 0.455747 19.382C0.77793 19.7275 1.22841 19.9239 1.70075 19.9239H15.1634C15.6358 19.9239 16.0863 19.7275 16.4084 19.382C16.7301 19.0365 16.8934 18.5729 16.8599 18.102L16.027 6.4393C15.9633 5.54904 15.2227 4.85948 14.3305 4.85948H13.0486V4.6165C13.0486 2.06674 10.9819 0 8.43209 0C5.97563 0 3.70528 1.95643 3.81559 4.6165C3.81899 4.69717 3.82191 4.77832 3.82483 4.85948ZM13.0486 6.31732V9.96193C13.0486 10.3643 12.722 10.6908 12.3197 10.6908C11.9173 10.6908 11.5908 10.3643 11.5908 9.96193V6.31732H5.27343V9.96193C5.27343 10.3643 4.94688 10.6908 4.54451 10.6908C4.14215 10.6908 3.81559 10.3643 3.81559 9.96193C3.81559 9.96193 3.87877 8.25868 3.85787 6.31732H2.53366C2.40634 6.31732 2.30041 6.41596 2.29166 6.54279L1.45825 18.2055C1.45339 18.2731 1.47673 18.3392 1.52289 18.3887C1.56906 18.4378 1.6332 18.466 1.70075 18.466H15.1634C15.231 18.466 15.2951 18.4378 15.3413 18.3887C15.3875 18.3392 15.4108 18.2731 15.4059 18.2055L14.5725 6.54279C14.5638 6.41596 14.4578 6.31732 14.3305 6.31732H13.0486ZM11.5908 4.85948V4.6165C11.5908 2.87195 10.1766 1.45784 8.43209 1.45784C6.68754 1.45784 5.27343 2.87195 5.27343 4.6165V4.85948H11.5908Z"
                        fill="black" />
                </svg>
                ...
                {{-- Removed the old inline count ( <span x-text="$store.cart.count > 0 ? $store.cart.count : 0"></span>
                ) --}}
        ...
        <div id="search-btn" class="hidden md:flex p-3 rounded-full transition-colors duration-300 cursor-pointer">
            ...
            <svg id="search-icon" class="w-40" viewBox="0 0 221 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M9.82955 8.09091C9.74905 7.28125 9.39157 6.63731 8.7571 6.15909C8.12263 5.68087 7.32481 5.44176 6.36364 5.44176C5.68655 5.44176 5.08996 5.55777 4.57386 5.78977C4.0625 6.02178 3.66004 6.34375 3.36648 6.75568C3.07765 7.16288 2.93324 7.62689 2.93324 8.14773C2.93324 8.53125 3.0161 8.86742 3.18182 9.15625C3.34754 9.44508 3.57008 9.69365 3.84943 9.90199C4.13352 10.1056 4.44602 10.2808 4.78693 10.4276C5.13258 10
39.5099ZM45.9233 12.4375L49.5028 19H47.9688L44.4247 12.4375H45.9233ZM63.5192 9H62.1839C62.0845 8.50284 61.9046 8.04356 61.6442 7.62216C61.3885 7.19602 61.0665 6.82434 60.6783 6.5071C60.29 6.18987 59.8497 5.94366 59.3572 5.76847C58.8648 5.59328 58.3321 5.50568 57.7592 5.50568C56.8407 5.50568 56.0026 5.74479 55.245 6.22301C54.4922 6.70123 53.8885 7.40436 53.4339 8.33239C52.9841 9.25568 52.7592 10.3873 52.7592 11.7273C52.7592 13.0767 52.9841 14.2131 53.4339 15.1364C53.8885 16.0597 54.4922 16.7604 55.245 17.2386C56.0026 17.7121 56.8407 17.9489 57.7592 17.9489C58.3321 17.9489 58.8648 17.8613 59.3572 17.6861C59.8497 17.5109 60.29 17.267 60.6783 16.9545C61.0665 16.6373 61.3885 16.2656 61.6442 15.8395C61.9046 15.4134 62.0845 14.9517 62.1839 14.4545H63.5192C63.4008 15.1222 63.1783 15.7448 62.8516 16.3224C62.5296 16.8954 62.1177 17.3973 61.6158 17.8281C61.1186 18.259 60.5457 18.5952 59.897 18.8366C59.2483 19.0781 58.5357 19.1989 57.7592 19.1989C56.5376 19.1989 55.4534 18.8935 54.5064 18.2827C53.5594 17.6671 52.8161 16.8007 52.2763 15.6832C51.7412 14.5658 51.4737 13.2472 51.4737 11.7273C51.4737 10.2074 51.7412 8.88873 52.2763 7.77131C52.8161 6.65388 53.5594 5.78977 54.5064 5.17898C55.4534 4.56345 56.5376 4.25568 57.7592 4.25568C58.5357 4.25568 59.2483 4.37642 59.897 4.6179C60.5457 4.85464 61.1186 5.19081 61.6158 5.62642C62.1177 6.05729 62.5296 6.55919 62.8516 7.1321C63.1783 7.70502 63.4008 8.32765 63.5192 9ZM66.6388 19V4.45455H67.967V11.1236H76.2198V4.45455H77.5479V19H76.2198V12.3168H67.967V19H66.6388Z"
                    fill="black" />
                <path d="M81.9414 19H220.941" stroke="black" />
            </svg>
        </div>


        <!-- Cart Drawer -->
        <div x-show="cartOpen" x-transition x-cloak x-data="{ tab: 'cart', policyOpen: false }"
            ...
            <div class="flex border-b justify-between">
                <div class="text-[#000] px-4 py-4">
                    <button @click="tab = 'cart'" :class="tab === 'cart' ? 'font-[400] border-b-2 border-black' : ''"
                        class="px-4 py-2">
                            ...
                            <div class="flex items-start justify-between p-2 mt-auto">
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mt-1">
                                        <!-- Show size and slash only if size exists -->
                                        <template x-if="item.size">
                                            <span class="text-[14px] text-[#000] uppercase" x-text="item.size"></span>
                                        </template>
                                        <template x-if="item.size">
                                            <span>/</span>
                                        </template>
                                        ...
                                        <!-- Always show color -->
                                        <span class="text-[14px] text-[#000] capitalize" x-text="item.color"></span>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <button @click="
                                                if (item.qty < item.stock) {
                                                    $store.cart.increase(index);
                                                } else {
                                                    $store.toast.trigger('Cannot add more than available stock!');
                                                }
                                            "
                                ...
                                <div x-data x-show="$store.toast.show" x-text="$store.toast.message" x-transition
            ...
            <div x-show="tab === 'cart'" class="p-4 border-t text-[#000]">
                ...
                <button @click="policyOpen = true" class="w-full bg-black text-white px-4 py-2">
                    Checkout
                </button>
            </div>
            ...
            <div x-show="policyOpen" x-cloak
                ...
                <div x-data="{ accept: false, scrollEnd: false }"
                    class="bg-white w-[90%] md:w-[500px] p-6 rounded shadow-lg text-black">


                    <!-- Scrollable English policy -->
                    <div class="text-sm space-y-1 h-[50vh] overflow-y-auto border p-2 mb-4" x-ref="policyBox" @scroll="
                        ...
                        <ul class="space-y-1">
                            <li class="list-none before:content-['*'] before:mr-1">
                                You have 10 days after the date of the purchase in-store or shopping online date.
                            </li>
                            <li class="list-none before:content-['*'] before:mr-1">
                                You have 10 days from the date of purchase in-store or the shopping online date.
                            </li>
                            <li class="list-none before:content-['*'] before:mr-1">
                                Items must be in their original, unworn condition and include all labels.
                            </li>
                            <li class="list-none before:content-['*'] before:mr-1">
                                You can change only available size or color with the same item or new item.
                            </li>
                            <li class="list-none before:content-['*'] before:mr-1">
                                You can exchange items in any physical Clobber Branches where the purchase was made
                                (Vanaci brand is available in every Clobber Branch).
                            </li>
                            <li class="list-none before:content-['*'] before:mr-1">
                                Bring the original receipt
                            </li>
                            <li class="list-none before:content-['*'] before:mr-1">
                                You can exchange both in-store and online purchases in a physical store.
                            </li>
                            <li class="list-none before:content-['*'] before:mr-1">
                                No refund
                            </li>
                    ...
                    <label class="flex items-center gap-2 mb-4 cursor-pointer">
                        <input type="checkbox" x-model="accept" :disabled="!scrollEnd" class="w-4 h-4">
                        <span class="text-sm" :class="{ 'text-gray-400': !scrollEnd }">I have read and accept the
                            store policy</span>
                    </label>

                    <!-- Buttons -->
                    <div class="flex justify-end gap-3">
                        <button class="px-4 py-2 bg-red-500 rounded text-white" @click="policyOpen = false">
                            Cancel
                        </button>

                        <button class="px-4 py-2 rounded text-white"
                            :class="accept ? 'bg-black cursor-pointer' : 'bg-gray-400 cursor-not-allowed'"
                            :disabled="!accept" @click="
                                if (accept) {
                                    policyOpen = false;
                                    $store.cart.confirmCheckout();
                                }
                            ">
                            Checkout
                        </button>
    ...
    <a href="{{ route('home') }}" class="w-1/3 flex items-center justify-center">
        <svg class="w-12 h-12 md:w-20 md:h-20" viewBox="0 0 44 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
<div id="drawer"
    ...
    <ul class="p-4 space-y-4 text-[#000] mt-4">
        ...
        @foreach ($types as $type)
            <li x-data="{ open: false }" class="relative">
                <button @click="open = !open" class="w-full text-left text-[20px] italic flex justify-between items-center">
                    {{ $type->type }}
                    <svg :class="open ? 'rotate-180' : ''" class="w-5 h-5 ml-2 transition-transform duration-300"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
